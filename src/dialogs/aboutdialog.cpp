  ...
  , m_config(Configuration::getInstance())
{
  ...
  ui->lbLicense->setText(ui->lbLicense->text().arg(tr("Licensed under the"), tr("Waqf General Public License")));
  ui->lbHomepage->setText(ui->lbHomepage->text().arg(tr("Project Homepage")));
  ui->lbBugFeatureReq->setText(ui->lbBugFeatureReq->text().arg(tr("Report a bug/Request a feature")));
  ui->lbContribTranslation->setText(ui->lbContribTranslation->text().arg(tr("Contribute to translations")));
