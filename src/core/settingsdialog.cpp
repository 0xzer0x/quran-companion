...
void SettingsDialog::updateDailyVerse(bool on)
{
    m_settingsPtr->setValue("VOTD", on);
}

void SettingsDialog::updateFileWarning(bool on)
{
...
void SettingsDialog::updateAdaptiveFont(bool on)
{
