...
{
  QString msg = QCoreApplication::translate("BookmarksNotifier", "Verse added to bookmarks");
...
{
  QString msg = QCoreApplication::translate("BookmarksNotifier", "Verse removed from bookmarks");
