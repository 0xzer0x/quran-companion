...
{
  QString msg = QCoreApplication::translate("JobNotifier", "Download Completed") + ": " + job->name();
...
{
  QString msg = QCoreApplication::translate("JobNotifier", "Download Failed") + ": " + job->name();
