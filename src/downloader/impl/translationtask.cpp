...
{
  return QUrl::fromEncoded(("https://github.com/0xzer0x/quran-companion-extras/raw/"
                            "main/translations/" +
...
{
  return QFileInfo(m_downloadsDir.absoluteFilePath("translations/" + m_translations.at(m_idx).filename()));
}
