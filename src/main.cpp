...
int main(int argc, char *argv[])
{
    ...
    QSettings appSettings(configDir.filePath("qurancompanion.conf"), QSettings::IniFormat, &a);
...
void checkSettings(QSettings &settings)
{
    ...
    if (settings.allKeys() != defaultKeys) {
        ...
        settings.setValue("MissingFileWarning", settings.value("MissingFileWarning", true));
